...
WITH k AS (
  SELECT 1 s, 'Migration 1/13 · init' kontrol,
  ...
  UNION ALL SELECT 2, 'Migration 2/13 · koruma kurallari + RLS',
  ...
  UNION ALL SELECT 3, 'Migration 3/13 · davranis sablonu',
  ...
  UNION ALL SELECT 3.5, 'Migration 4/13 · teneffus cezasi',
  ...
  UNION ALL SELECT 3.6, 'Migration 5/13 · ders bitisi',
  ...
  UNION ALL SELECT 3.7, 'Migration 6/13 · odev modulu',
  ...
  UNION ALL SELECT 3.8, 'Migration 7/13 · tek acik ders kisiti',
  ...
  UNION ALL SELECT 3.9, 'Migration 8/13 · sinav ogretmene tasindi',
  ...
  UNION ALL SELECT 3.95, 'Migration 9/13 · sinav bilesenleri',
  ...
  UNION ALL SELECT 3.96, 'Migration 10/13 · tahta kilidi',
  ...
  UNION ALL SELECT 3.97, 'Migration 11/13 · veli izin onayi',
  ...
  UNION ALL SELECT 3.98, 'Migration 12/13 · sinif hedefleri',
  ...
  UNION ALL SELECT 3.99, 'Migration 13/13 · exp sistemi',
  ...
  UNION ALL SELECT 4, 'Fazladan/taninmayan migration kaydi',
    (SELECT coalesce(string_agg(migration_name,', '),'yok') FROM "_prisma_migrations"
       WHERE migration_name NOT IN ('20260821214524_init','20260822105533_harden_history_and_rls',
                                    ...
                                    '20260912192838_exp_sistemi')), 'yok'
  ...
  UNION ALL SELECT 6, 'Tablo sayisi',
    (SELECT count(*)::text FROM pg_tables WHERE schemaname='public' AND tablename<>'_prisma_migrations'), '15'
  ...
  UNION ALL SELECT 11, 'RLS acik tablo',
    (SELECT count(*)::text FROM pg_tables WHERE schemaname='public' AND tablename<>'_prisma_migrations' AND rowsecurity), '15'
)
